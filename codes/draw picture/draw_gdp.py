...
#df = pd.DataFrame({'year': years, 'gdp_rate' : gdp_rate, 'first_industry_rate' : first_industry_rate})
#ax1 = df.plot(x = 'year', y = ['gdp_rate', 'first_industry_rate'])
#sns.set()
#ax2 = sns.lineplot(x = years, y = gdp_rate)
#plt.show
